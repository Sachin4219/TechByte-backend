...
export const getMyPosts = async ( req, res ) => {
    ...
    try {
        ...
        const posts = await Post.find( { _id: { $in: foundAuthor.posts } } )
...
export const getSinglePost = async ( req, res ) => {
    const serviceResponse = { ...Response }
    try {
        const singleposts = await Post.findById( req.params.id )
        serviceResponse.success = true
        serviceResponse.msg = "posts fetched successfully"
...
export const deletePost = async ( req, res ) => {
    ...
    try {
        ...
        if ( post.createdBy.toString() === req.authorData.id.toString() ) {
